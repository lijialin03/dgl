...
class ShiftedSoftplus(paddle.nn.Layer):
    ...
    def __init__(self, beta=1, shift=2, threshold=20):
        ...
        self.shift = shift
        self.softplus = paddle.nn.Softplus(beta=beta, threshold=threshold)
...
class CFConv(paddle.nn.Layer):
    """CFConv from `SchNet: A continuous-filter convolutional neural network for
