...
class APPNPConv(paddle.nn.Layer):
    """Approximate Personalized Propagation of Neural Predictions layer from `Predict then
    ...
    def __init__(self, k, alpha, edge_drop=0.0):
        ...
        self._k = k
        self._alpha = alpha
        self.edge_drop = paddle.nn.Dropout(p=edge_drop)
